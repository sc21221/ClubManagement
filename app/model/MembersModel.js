Ext.define('ClubManagement.model.Members', {
    ...
    fields: [
		...
		{name: 'gebdat', type: 'date', dateformat: "Y-m-d"},
		{name: 'eindat', type: 'date', dateformat: "Y-m-d"},
		{name: 'sonderdat', type: 'date', dateformat: "Y-m-d"},
		{name: 'ausdat', type: 'date', dateformat: "Y-m-d"},
